...
// deleteTokensFromKeyring removes all stored tokens from the Linux
// secret-service. Returns the first error encountered; callers log or
// surface it rather than pretending logout always succeeded (H-AUTH-3).
